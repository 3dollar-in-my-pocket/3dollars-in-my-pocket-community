...
public class UserCouponController {
    ...
    @RequestApiKey ApiKeyContext workspaceId, @RequestParam String accountId) {
        userCouponService.issueCoupon(workspaceId.getWorkspaceId(), couponGroup, couponId, accountId);
